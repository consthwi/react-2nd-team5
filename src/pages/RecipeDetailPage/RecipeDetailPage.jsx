...
const RecipeDetailPage = () => {
  return (
    ...
    <Row className='mb-5'>
      <Col><div style={{
        backgroundImage:"url(https://t1.daumcdn.net/news/202105/25/dailylife/20210525044309969jdhs.jpg)" 
      ...
      <div className='text-2 mt-3'>추운겨울엔 이만한게 없죠! <br/>정말 맛있는 밀푀유나배 만들기도 너무 쉽고 따끈한 국물까지 마시면 정말 든든한 한끼랍니다! 집들이 메인요리로도 손색이없어요 </div>
      </div>
