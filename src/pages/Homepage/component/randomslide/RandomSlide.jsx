      ...
      {choice && (
        <Container>
          <Row className="randomslide_h4">
            <h3 className="todays_menu slidertitle">
              <FontAwesomeIcon icon={faSpoon} /> 오늘은 이런 메뉴 어때요?
            </h3>
          </Row>
          <Row>
            ...
            >
              ...
              <div className="randomslide_rcp_nm_style">
                <span className="randomslide_rcp_nm_style">
                  {" "}
                  {randomRecipe.RCP_NM}{" "}
                </span>
              </div>
              <div>
                ...
                <span className="random_dtls random_rcp"> 재료 </span>
                <span className="random_rcp">
                  {" "}
              ...
              <div>
                ...
                <span className="random_dtls random_rcp"> 꿀팁 </span>
                <span className="random_rcp">{randomRecipe.RCP_NA_TIP}</span>
              </div>
              <div className="buttonstyle">
                <Button
                  variant="outline-secondary"
                  className="random_rcp random_dtls "
                  onClick={gomore}
                >
                  자세히 보기
                </Button>
